...
const REAL = JSON.stringify([
	{ id: '3f239506', cwd: '/x/draftingroom', kind: 'background', startedAt: 1785814301517, sessionId: '3f239506-cf62-4836-81ce-131f960e26ed', name: 'Build a dashboard', state: 'blocked' },
	{ id: '86031b90', cwd: '/x/projects', kind: 'interactive', startedAt: 1786033920777, sessionId: '86031b90-0497-4881-a13e-66f993ec4859', name: 'projects-a2', pid: 5157, status: 'busy' },
])
...
test('a CLI payload becomes registry entries', () => {
	...
	assert.deepEqual(out[0], {
		pid: 5157,
		sessionId: '86031b90-0497-4881-a13e-66f993ec4859',
		cwd: '/x/projects',
		name: 'projects-a2',
		status: 'busy',
